...
//	}
	...
	@DeleteMapping(value = "removeFile", consumes = "application/json", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<String>fileRemove(@RequestBody FileVO fvo){
		log.info(">>>>>remove fvo>>>>{}",fvo);
